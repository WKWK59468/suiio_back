...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  PRIMARY KEY (`ID`),
  KEY `sID_comment` (`sID`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='留言';
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  PRIMARY KEY (`id`),
  KEY `who` (`who`)
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8 COMMENT='通知';
