...
router.route("/upload/image").post(UserController.check, UserController.check_permission, UserController.check_permission_finance, imageUploadController.uploadFile);
...
router.route("/upload/document").post(UserController.check, UserController.check_permission, UserController.check_permission_finance, docUploadController.uploadFile);
